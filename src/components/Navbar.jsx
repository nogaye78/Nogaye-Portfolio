...
//   const bg = dark ? "rgba(15,15,15,0.95)" : "rgba(240,240,240,0.95)";
//   const textColor = dark ? "#666" : "#777";
//   const logoColor = dark ? "#F0F0F0" : "#111111";
//   const borderColor = scrolled ? (dark ? "#2a2a2a" : "#D8D8D8") : "transparent";
...
//       <button onClick={() => setDark(!dark)} style={{
//         background: "transparent",
//         border: "1px solid " + (dark ? "#2a2a2a" : "#D0D0D0"),
//         borderRadius: 100, padding: "0.4rem 1rem",
//         cursor: "pointer", fontSize: "0.78rem",
//         color: textColor, fontFamily: "'DM Sans', sans-serif",
//         transition: "all 0.3s", display: "flex", alignItems: "center", gap: "0.4rem",
...
//         onMouseLeave={e => e.currentTarget.style.borderColor = dark ? "#2a2a2a" : "#D0D0D0"}
//       >
//         {dark ? "☀️ Clair" : "🌙 Sombre"}
//       </button>
...
//       {open && (
//         <div style={{ position: "absolute", top: "100%", left: 0, right: 0, background: bg, backdropFilter: "blur(20px)", padding: "1.5rem 2rem", display: "flex", flexDirection: "column", gap: "1rem", borderBottom: "1px solid " + (dark ? "#2a2a2a" : "#D8D8D8") }}>
//           {links.map(({ href, label }) => (
//             <a key={href} href={href} onClick={() => setOpen(false)}
