...
function PreviewModal({ proj, dark, onClose }) {
  ...
  const tagBg = dark ? "#222" : "#FDF0EE";
  const btnBorder = dark ? "#2a2a2a" : "#F5C9C3";
    ...
    >
      <div
        ...
        style={{
          ...
          border: "1px solid " + (dark ? "#2a2a2a" : "#F5C9C3"),
          position: "relative",
          maxHeight: "85vh",
          overflowY: "auto",
          scrollbarWidth: "thin",
          scrollbarColor: "#E85D4A transparent",
        }}
      >
        <button
          onClick={onClose}
          style={{
            ...
            right: 12,
            zIndex: 20,
            background: dark ? "#222" : "#FDF0EE",
            border: "none",
            color: dark ? "#E85D4A" : "#E85D4A",
            width: 36,
            height: 36,
            borderRadius: "50%",
            cursor: "pointer",
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.background = "#E85D4A";
            e.currentTarget.style.color = "#0F0F0F";
            e.currentTarget.style.transform = "scale(1.1) rotate(90deg)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.background = dark ? "#222" : "#FDF0EE";
            e.currentTarget.style.color = dark ? "#E85D4A" : "#E85D4A";
            ...
            {proj.tech.map((t) => (
              <span
                ...
                style={{
                  ...
                  background: tagBg,
                  color: dark ? "#E85D4A" : "#E85D4A",
                  border: "1px solid " + (dark ? "#8B2E20" : "#F5C9C3"),
                }}
              >
                {t}
              </span>
          ...
          <div style={{ display: "flex", gap: "0.8rem" }}>
            <a
              ...
              style={{
                ...
                textDecoration: "none",
                transition: "all 0.3s",
                boxShadow: "0 4px 20px rgba(232,93,74,0.4)",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "#C94535";
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 16,
        overflow: "hidden",
        border: hovered ? "1px solid #E85D4A" : "1px solid " + border,
        boxShadow: hovered
          ? "0 16px 50px rgba(232,93,74,0.15)"
          : dark
          ? "0 2px 16px rgba(0,0,0,0.3)"
          : "0 2px 16px rgba(0,0,0,0.05)",
        transform: hovered ? "translateY(-6px)" : "translateY(0)",
        transition: "all 0.35s ease, opacity 0.8s ease",
        opacity: visible ? 1 : 0,
        cursor: "pointer",
      }}
  ...
  return (
    <section id="portfolio" style={{ padding: "7rem 5rem", background: bg }}>
      ...
      >
        ...
        >
          Mes{" "}
          <em style={{ fontStyle: "italic", color: "#E85D4A" }}>Projets</em>
        </h2>
        ...
        >
          Cliquez sur une carte pour voir l&apos;apercu
        </p>
      </div>
